import{_ as s,c as a,o as n,a as p}from"./app.9bca02c0.js";const y=JSON.parse('{"title":"display \u5C5E\u6027","description":"","frontmatter":{},"headers":[],"relativePath":"files/css/grid.md"}'),l={name:"files/css/grid.md"},e=p(`<h4 id="display-\u5C5E\u6027" tabindex="-1">display \u5C5E\u6027 <a class="header-anchor" href="#display-\u5C5E\u6027" aria-hidden="true">#</a></h4><div class="language-"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">display\uFF1Agrid</span></span>
